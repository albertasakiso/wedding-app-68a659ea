        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          {events.map((event, index) => {
            ...
            return (
              <div
                key={event.id}
                className={`relative flex items-start gap-8 mb-12 last:mb-0 ${isEven ? "md:flex-row" : "md:flex-row-reverse"}`}
              >
                ...
                <div className={`ml-24 md:ml-0 md:w-1/2 ${isEven ? "md:pr-16 md:text-right" : "md:pl-16 md:text-left"}`}>
